...
class ProviderPanelController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $request->validate([
            ...
            'provider_email' => 'required|string|email|max:255|unique:users,email|unique:providers,provider_email',
            ...
            'provider_zipcode' => 'required|numeric|exists:zipcode_reference,zipcode',
