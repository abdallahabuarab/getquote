...
window.Echo = new Echo({
    ...
    forceTLS: true // Use true if you are using HTTPS
});
...
// window.Echo = new Echo({
//     broadcaster: 'pusher',
//     key: '73148db7be80360495d9',  // Your Pusher App Key
...
// window.Echo = new Echo({
//     broadcaster: 'pusher',
//     key: import.meta.env.VITE_PUSHER_APP_KEY,  // Uses environment variables from .env file
