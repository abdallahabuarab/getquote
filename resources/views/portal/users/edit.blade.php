...
<div class="page-content">
    <div class="container-fluid">
        ...
        <form id="edit-user" class="form-horizontal" action="{{ route('userspa.update', $user->id) }}" method="post" enctype="multipart/form-data">
            @csrf
            @method('PUT')
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-4">
                                    <input class="form-control @error('name') is-invalid @enderror" type="text" placeholder="Name" id="name" name="name" value="{{ old('name', $user->name) }}">
                                    @error('name')
